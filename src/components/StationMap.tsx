...
import { PARAGRAPH_LOCATION_MAP } from '../engine/mapData';
...
export function StationMap({ onClose }: { onClose?: () => void }) {
  ...
  // Map paragraphs to locations — data from mapData.ts (Stage 8.5)
  const paragraphLocationMap = PARAGRAPH_LOCATION_MAP;
